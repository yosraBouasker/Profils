...
public class JSONParser {
	...
	public static JSONObject makeRequest( String u ) //u: URL vers le fichier php
	{
		HttpURLConnection conn=null;
		try {

			URL url = new URL(u);
			conn= (HttpURLConnection) url.openConnection(); //elle ne pas etre faite dan le UIThread
